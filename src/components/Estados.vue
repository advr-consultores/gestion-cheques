  ...
  <v-row>
    <v-col cols="12" sm="12">
      <v-autocomplete
        ...
        item-value="nombre"
        clearable
        no-data-text="No se encontró ningún estado."
        label="Estado"
      />
    </v-col>
    <v-col cols="12" sm="12">
      <v-autocomplete
        ...
        item-value="nombre"
        clearable
        no-data-text="No se ha encontró ningún muncipio."
        label="Municipio"
      />
    </v-col>
  </v-row>
...
export default {
  ...
  data: () => ({
    ...
    estados: [
      ...
      { clave: "CHI", nombre: "Campeche" },
      { clave: "CHS", nombre: "Coahuila" },
      { clave: "CMP", nombre: "Colima" },
      { clave: "CMX", nombre: "Chiapas" },
      { clave: "COA", nombre: "Chihuahua" },
      { clave: "COL", nombre: "Ciudad de Mexico" },
      { clave: "DGO", nombre: "Durango" },
      { clave: "GRO", nombre: "Guanajuato" },
      { clave: "GTO", nombre: "Guerrero" },
      { clave: "HGO", nombre: "Hidalgo" },
      { clave: "JAL", nombre: "Jalisco" },
      { clave: "MCH", nombre: "Estado de Mexico" },
      { clave: "MEX", nombre: "Michoacan" },
      { clave: "MOR", nombre: "Morelos" },
      { clave: "NAY", nombre: "Nayarit" },
      { clave: "NL", nombre: "Nuevo Leon" },
      { clave: "OAX", nombre: "Oaxaca" },
      { clave: "PUE", nombre: "Puebla" },
      { clave: "QR", nombre: "Queretaro" },
      { clave: "QRO", nombre: "Quintana Roo" },
      { clave: "SIN", nombre: "San Luis Potosi" },
      { clave: "SLP", nombre: "Sinaloa" },
      { clave: "SON", nombre: "Sonora" },
      { clave: "TAB", nombre: "Tabasco" },
      { clave: "TLX", nombre: "Tamaulipas" },
      { clave: "TMS", nombre: "Tlaxcala" },
