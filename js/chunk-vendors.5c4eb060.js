 ...
 * limitations under the License.
 */
const O="FirebaseError";class x extends Error{constructor(t,e,n){super(e),this.code=t,this.customData=n,this.name=O,Object.setPrototypeOf(this,x.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,T.prototype.create)}}class T{constructor(t,e,n){this.service=t,this.serviceName=e,this.errors=n}create(t,...e){const n=e[0]||{},i=`${this.service}/${t}`,r=this.errors[t],s=r?E(r,n):"Error",o=`${this.serviceName}: ${s} (${i}).`,a=new x(i,o,n);return a}}function E(t,e){return t.replace(A,(t,n)=>{const i=e[n];return null!=i?String(i):`<${n}?>`})}const A=/\{\$([^}]+)}/g;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function In(t){return{type:"value",snapshotNode:t}}function On(t,e){return{type:"child_added",snapshotNode:e,childName:t}}function xn(t,e){return{type:"child_removed",snapshotNode:e,childName:t}}function Tn(t,e,n){return{type:"child_changed",snapshotNode:e,childName:t,oldSnap:n}}function En(t,e){return{type:"child_moved",snapshotNode:e,childName:t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class An{constructor(t){this.index_=t}updateChild(t,e,n,i,r,o){Object(s["f"])(t.isIndexed(this.index_),"A node must be indexed if only a child is updated");const a=t.getImmediateChild(e);return a.getChild(i).equals(n.getChild(i))&&a.isEmpty()===n.isEmpty()?t:(null!=o&&(n.isEmpty()?t.hasChild(e)?o.trackChildChange(xn(e,a)):Object(s["f"])(t.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):a.isEmpty()?o.trackChildChange(On(e,n)):o.trackChildChange(Tn(e,n,a))),t.isLeafNode()&&n.isEmpty()?t:t.updateImmediateChild(e,n).withIndex(this.index_))}updateFullNode(t,e,n){return null!=n&&(t.isLeafNode()||t.forEachChild(an,(t,i)=>{e.hasChild(t)||n.trackChildChange(xn(t,i))}),e.isLeafNode()||e.forEachChild(an,(e,i)=>{if(t.hasChild(e)){const r=t.getImmediateChild(e);r.equals(i)||n.trackChildChange(Tn(e,i,r))}else n.trackChildChange(On(e,i))})),e.withIndex(this.index_)}updatePriority(t,e){return t.isEmpty()?mn.EMPTY_NODE:t.updatePriority(e)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Is{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Os(t,e){let n=null;for(let i=0;i<e.length;i++){const r=e[i],s=r.getPath();null===n||we(s,n.path)||(t.eventLists_.push(n),n=null),null===n&&(n={events:[],path:s}),n.events.push(r)}n&&t.eventLists_.push(n)}function xs(t,e,n){Os(t,n),Es(t,t=>we(t,e))}function Ts(t,e,n){Os(t,n),Es(t,t=>Ce(t,e)||Ce(e,t))}function Es(t,e){t.recursionDepth_++;let n=!0;for(let i=0;i<t.eventLists_.length;i++){const r=t.eventLists_[i];if(r){const s=r.path;e(s)?(As(t.eventLists_[i]),t.eventLists_[i]=null):n=!1}}n&&(t.eventLists_=[]),t.recursionDepth_--}function As(t){for(let e=0;e<t.events.length;e++){const n=t.events[e];if(null!==n){t.events[e]=null;const i=n.getEventRunner();_&&k("event: "+n.toString()),q(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
const wo="FIREBASE_DATABASE_EMULATOR_HOST",Co={};let ko=!1;function So(e,n,i,r,s){let o=r||e.options.databaseURL;void 0===o&&(e.options.projectId||O("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),k("Using default host for project ",e.options.projectId),o=e.options.projectId+"-default-rtdb.firebaseio.com");let a,c=co(o,s),l=c.repoInfo,u=void 0;"undefined"!==typeof t&&(u=Object({NODE_ENV:"production",VUE_APP_API_KEY:"AIzaSyDxbMGWiD2Wr9qy8wrxA4VkI581EgKPj4s",VUE_APP_AUTH_DOMAIN:"advr-consultores.firebaseapp.com",VUE_APP_DATABASE_URL:"https://advr-consultores-default-rtdb.firebaseio.com",VUE_APP_PROJECT_ID:"advr-consultores",VUE_APP_STORAGE_BUCKET:"advr-consultores.appspot.com",VUE_APP_MESSAGING_SENDER_ID:"950650780471",VUE_APP_APP_ID:"1:950650780471:web:6bbc43f41d56abc9fcf8b2",VUE_APP_MEASUREMENT_ID:"G-SRQCGWSDVY",BASE_URL:"/gestion-cheques/"})[wo]),u?(a=!0,o=`http://${u}?ns=${l.namespace}`,c=co(o,s),l=c.repoInfo):a=!c.repoInfo.secure;const h=s&&a?new J(J.OWNER):new X(e.name,e.options,n);Ss("Invalid Firebase Database URL",c),ye(c.path)||O("Database URL must point to the root of a Firebase Database (not including a child path).");const d=Oo(l,e,h,new Y(e.name,i));return new xo(d,e)}function Io(t,e){const n=Co[e];n&&n[t.key]===t||O(`Database ${e}(${t.repoInfo_}) has already been deleted.`),qs(t),delete n[t.key]}function Oo(t,e,n,i){let r=Co[e.name];r||(r={},Co[e.name]=r);let s=r[t.toURLString()];return s&&O("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),s=new Ps(t,ko,n,i),r[t.toURLString()]=s,s}class xo{constructor(t,e){this._repoInternal=t,this.app=e,this["type"]="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(Ls(this._repoInternal,this.app.options.appId,this.app.options["databaseAuthVariableOverride"]),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new ho(this._repo,le())),this._rootInternal}_delete(){return null!==this._rootInternal&&(Io(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(t){null===this._rootInternal&&O("Cannot call "+t+" on a deleted database.")}}function To(t=Object(i["d"])(),e){return Object(i["b"])(t,"database").getImmediate({identifier:e})}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ot(t){if(!t)throw d()}function xt(t,e){function n(n,i){const r=Ct(t,i,e);return Ot(null!==r),r}return n}function Tt(t,e){function n(n,i){const r=Ct(t,i,e);return Ot(null!==r),kt(r,i,t.host,t._protocol)}return n}function Et(t){function e(e,n){let i;return i=401===e.getStatus()?e.getErrorText().includes("Firebase App Check token is invalid")?v():m():402===e.getStatus()?f(t.bucket):403===e.getStatus()?g(t.path):n,i.serverResponse=n.serverResponse,i}return e}function At(t){const e=Et(t);function n(n,i){let r=e(n,i);return 404===n.getStatus()&&(r=p(t.path)),r.serverResponse=i.serverResponse,r}return n}function $t(t,e,n){const i=e.fullServerUrl(),r=B(i,t.host,t._protocol),s="GET",o=t.maxOperationRetryTime,a=new It(r,s,Tt(t,n),o);return a.errorHandler=At(e),a}function jt(t,e){const n=e.fullServerUrl(),i=B(n,t.host,t._protocol),r="DELETE",s=t.maxOperationRetryTime;function o(t,e){}const a=new It(i,r,o,s);return a.successCodes=[200,204],a.errorHandler=At(e),a}function Pt(t,e){return t&&t["contentType"]||e&&e.type()||"application/octet-stream"}function Lt(t,e,n){const i=Object.assign({},n);return i["fullPath"]=t.path,i["size"]=e.size(),i["contentType"]||(i["contentType"]=Pt(null,e)),i}function Nt(t,e,n,i,r){const s=e.bucketOnlyServerUrl(),o={"X-Goog-Upload-Protocol":"multipart"};function a(){let t="";for(let e=0;e<2;e++)t+=Math.random().toString().slice(2);return t}const c=a();o["Content-Type"]="multipart/related; boundary="+c;const l=Lt(e,i,r),u=St(l,n),h="--"+c+"\r\nContent-Type: application/json; charset=utf-8\r\n\r\n"+u+"\r\n--"+c+"\r\nContent-Type: "+l["contentType"]+"\r\n\r\n",d="\r\n--"+c+"--",p=ut.getBlob(h,i,d);if(null===p)throw k();const f={name:l["fullPath"]},m=B(s,t.host,t._protocol),v="POST",g=t.maxUploadRetryTime,y=new It(m,v,xt(t,n),g);return y.urlParams=f,y.headers=o,y.body=p.uploadData(),y.errorHandler=Et(e),y}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const S="firebase-messaging-database",I=1,O="firebase-messaging-store";let x=null;function T(){return x||(x=Object(r["openDb"])(S,I,t=>{switch(t.oldVersion){case 0:t.createObjectStore(O)}})),x}async function E(t){const e=j(t),n=await T(),i=await n.transaction(O).objectStore(O).get(e);if(i)return i;{const e=await C(t.appConfig.senderId);if(e)return await A(t,e),e}}async function A(t,e){const n=j(t),i=await T(),r=i.transaction(O,"readwrite");return await r.objectStore(O).put(e,n),await r.complete,e}async function $(t){const e=j(t),n=await T(),i=n.transaction(O,"readwrite");await i.objectStore(O).delete(e),await i.complete}function j({appConfig:t}){return t.appId}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const C="firebase-messaging-database",k=1,S="firebase-messaging-store";let I=null;function O(){return I||(I=Object(r["openDb"])(C,k,t=>{switch(t.oldVersion){case 0:t.createObjectStore(S)}})),I}async function x(t){const e=A(t),n=await O(),i=await n.transaction(S).objectStore(S).get(e);if(i)return i;{const e=await _(t.appConfig.senderId);if(e)return await T(t,e),e}}async function T(t,e){const n=A(t),i=await O(),r=i.transaction(S,"readwrite");return await r.objectStore(S).put(e,n),await r.complete,e}async function E(t){const e=A(t),n=await O(),i=n.transaction(S,"readwrite");await i.objectStore(S).delete(e),await i.complete}function A({appConfig:t}){return t.appId}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function S(){var t;return"undefined"!==typeof self&&(null===(t=self.location)||void 0===t?void 0:t.href)||""}function I(){return"http:"===O()||"https:"===O()}function O(){var t;return"undefined"!==typeof self&&(null===(t=self.location)||void 0===t?void 0:t.protocol)||null}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function x(){return!("undefined"!==typeof navigator&&navigator&&"onLine"in navigator&&"boolean"===typeof navigator.onLine&&(I()||Object(i["u"])()||"connection"in navigator))||navigator.onLine}function T(){if("undefined"===typeof navigator)return null;const t=navigator;return t.languages&&t.languages[0]||t.language||null}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ce(t,e,n=!1){const i="signIn",r=await se(t,i,e),s=await ne._fromIdTokenResponse(t,i,r);return n||await t._updateCurrentUser(s.user),s}async function le(t,e){return ce(It(t),e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Oe extends _e{constructor(){super(()=>window.sessionStorage,"SESSION")}_addListener(t,e){}_removeListener(t,e){}}Oe.type="SESSION";const xe=Oe;
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Cn(t,e,n=!1){const i=It(t),r=cn(i,e),s=new yn(i,r,n),o=await s.execute();return o&&!n&&(delete o.user._redirectEventId,await i._persistUserIfCurrent(o.user),await i._setRedirectUser(null,e)),o}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const kn=6e5;class Sn{constructor(t){this.auth=t,this.cachedEventUids=new Set,this.consumers=new Set,this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1,this.lastProcessedEventTime=Date.now()}registerConsumer(t){this.consumers.add(t),this.queuedRedirectEvent&&this.isEventForConsumer(this.queuedRedirectEvent,t)&&(this.sendToConsumer(this.queuedRedirectEvent,t),this.saveEventToCache(this.queuedRedirectEvent),this.queuedRedirectEvent=null)}unregisterConsumer(t){this.consumers.delete(t)}onEvent(t){if(this.hasEventBeenHandled(t))return!1;let e=!1;return this.consumers.forEach(n=>{this.isEventForConsumer(t,n)&&(e=!0,this.sendToConsumer(t,n),this.saveEventToCache(t))}),this.hasHandledPotentialRedirect||!xn(t)||(this.hasHandledPotentialRedirect=!0,e||(this.queuedRedirectEvent=t,e=!0)),e}sendToConsumer(t,e){var n;if(t.error&&!On(t)){const i=(null===(n=t.error.code)||void 0===n?void 0:n.split("auth/")[1])||"internal-error";e.onError(f(this.auth,i))}else e.onAuthEvent(t)}isEventForConsumer(t,e){const n=null===e.eventId||!!t.eventId&&t.eventId===e.eventId;return e.filter.includes(t.type)&&n}hasEventBeenHandled(t){return Date.now()-this.lastProcessedEventTime>=kn&&this.cachedEventUids.clear(),this.cachedEventUids.has(In(t))}saveEventToCache(t){this.cachedEventUids.add(In(t)),this.lastProcessedEventTime=Date.now()}}function In(t){return[t.type,t.eventId,t.sessionId,t.tenantId].filter(t=>t).join("-")}function On({type:t,error:e}){return"unknown"===t&&"auth/no-auth-event"===(null===e||void 0===e?void 0:e.code)}function xn(t){switch(t.type){case"signInViaRedirect":case"linkViaRedirect":case"reauthViaRedirect":return!0;case"unknown":return On(t);default:return!1}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
